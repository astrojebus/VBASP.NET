...
Namespace Septimo  'Aqui----------------
    Public Class crMaterias  'Aqui----------------
        ...
        Public Overrides Property ResourceName() As String
            Get
                ...
                'Return "IngresosAranceles\rptFacturas.rpt"
                Return "Reportes\rptMaterias.rpt" 'Aqui----------------
            End Get
    ...
    Public Class CachedcrMaterias    'Aqui----------------
        Inherits Component
        ...
        Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
            Dim rpt As New crMaterias     'Aqui----------------
            rpt.Site = Me.Site
            Return rpt
        End Function
